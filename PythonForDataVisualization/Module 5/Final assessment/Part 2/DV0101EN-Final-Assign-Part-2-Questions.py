...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'textAlign': 'center', 'color': '#990000', 'font-size': '24px'}),#Include style for title
...
def update_output_container(statistic, selected_year):
    if statistic == 'Recession Period Statistics':
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="Average automobile sales per vehicle type during recession"))
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots                             
    elif (selected_year and statistic == 'Yearly Statistics') :
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(
            figure=px.line(monthly_sales, 
                        x='Month', 
                        y='Automobile_Sales',
                        title="Total Monthly Automobile Sales for the Year {}".format(selected_year))
        )
        ...
        Y_chart4 = dcc.Graph(
            figure=px.pie(exp_data, 
                        values='Advertising_Expenditure', 
                        names='Vehicle_Type',
                        title="Advertisement Expenditure by Vehicle Type for the Year {}".format(selected_year))
        )
